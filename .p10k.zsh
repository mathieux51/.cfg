# Generated by Powerlevel10k configuration wizard on 2020-05-23 at 09:55 CEST.
...
# flat tails, 2 lines, disconnected, left frame, lightest-ornaments, compact, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$DIR_BACKGROUND
